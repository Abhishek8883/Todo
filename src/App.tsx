...
const App = () => {
  ...
  return (
    <Container   maxWidth="sm" sx={{ height: "100vh" ,padding:1  }}>
      <AppBar  position="static">
        <Toolbar >
          <Typography>Daily Goals</Typography>
        </Toolbar>
      </AppBar>

      <Stack sx={{margin:"1rem 0"}} height={"70%"} direction={"column"} spacing={"1rem"} p={"1rem"} overflow={"auto"}>
        {todos.map((i) => (
          <TodoItem
